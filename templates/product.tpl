...
<div id="single-product" class="js-has-new-shipping js-product-detail js-product-container js-shipping-calculator-container" data-variants="{{product.variants_object | json_encode }}">
    <div class="container-fluid">
        <div class="section-product-detail">
            <div class="col-12 col-md-6 col-lg-7 pl-0 pr-0 product-detail-img-col" data-store="product-image-{{ product.id }}">
            	{% include 'snipplets/product/product-image.tpl' %}
            </div>
            <div class="product-detail-form-col" data-store="product-info-{{ product.id }}">
