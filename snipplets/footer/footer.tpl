...
{% set has_footer_contact_info = settings.contact_data_show and (store.phone or store.email or store.blog or store.address) %}          
...
<footer class="js-hide-footer-while-scrolling display-when-content-ready {% if template == 'cart' %}mt-0{% endif %}" data-store="footer">
	<div class="container">
		...
		<div class="row element-footer font-small font-weight-light">
			<div class="col-md-4 text-center text-md-left">
				{{ "© Copyright {1} - {2}" | translate( (store.business_name ? store.business_name : store.name) ~ (store.business_id ? ' - ' ~ store.business_id : ''), "now" | date('Y') ) }}
			</div>
            ...
            <div class="col-md-4 text-center text-md-right">
                {{ "Todos los derechos reservados." | translate }}
            </div>
        </div>
            ...
            <div class="row element-footer font-small font-weight-light">
                <div class="col text-center">
                    <div class="claim-link">
                        ...
                        <a class="font-weight-normal" href="https://www.argentina.gob.ar/produccion/defensadelconsumidor/formulario" target="_blank">{{ "ingrese aquí" | translate }}</a>
                    </div>
                </div>
            </div>
        {% endif %}
