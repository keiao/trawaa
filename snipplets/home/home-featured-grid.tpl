...
<div class="row">
    ...
    {% if featured_slider %}
                ...
                <div class="js-swiper-featured-prev swiper-button-prev d-none d-md-block">{% include "snipplets/svg/chevron-left.tpl" with {svg_custom_class: "svg-inline--fa fa-w-8 fa-2x svg-icon-text"} %}</div>
                <div class="js-swiper-featured-next swiper-button-next d-none d-md-block">{% include "snipplets/svg/chevron-right.tpl" with {svg_custom_class: "svg-inline--fa fa-w-8 fa-2x svg-icon-text"} %}</div>
            </div>
        </div>
    {% endif %}
